...
namespace {
struct qt_meta_tag_ZN9AdminFormE_t {};
} // unnamed namespace

template <> constexpr inline auto AdminForm::qt_create_metaobjectdata<qt_meta_tag_ZN9AdminFormE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<AdminForm, qt_meta_tag_ZN9AdminFormE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject AdminForm::staticMetaObject = { {
    QMetaObject::SuperData::link<QMainWindow::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9AdminFormE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9AdminFormE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN9AdminFormE_t>.metaTypes,
    nullptr
} };
...
void *AdminForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN9AdminFormE_t>.strings))
